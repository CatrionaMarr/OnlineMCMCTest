...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/b050942d702d604416d2068eb699d48b")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/b050942d702d604416d2068eb699d48b")
  success = False

database_add_row("b050942d702d604416d2068eb699d48b", "m*x+c", "m,c", 2, success)
