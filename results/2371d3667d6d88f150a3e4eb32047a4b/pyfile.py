...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/2371d3667d6d88f150a3e4eb32047a4b")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/2371d3667d6d88f150a3e4eb32047a4b")
  success = False

database_add_row("2371d3667d6d88f150a3e4eb32047a4b", "m*x+c", "m,c", 2, success)
