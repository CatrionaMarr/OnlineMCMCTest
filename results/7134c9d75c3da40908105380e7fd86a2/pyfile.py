...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/7134c9d75c3da40908105380e7fd86a2")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/7134c9d75c3da40908105380e7fd86a2")
  success = False

  # run post-processing script
  try:
    MCMCWrapper(1 2 3 4, "m,c", m,x,c, "emcee")
xdatabase_add_row("7134c9d75c3da40908105380e7fd86a2", "m*x+c", "m,c", 2, success)
