...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/7a0cb8fb857a1801ebd2d315c748305f")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/7a0cb8fb857a1801ebd2d315c748305f")
  success = False

database_add_row("7a0cb8fb857a1801ebd2d315c748305f", "m*x+c", "m,c", 2, success)
