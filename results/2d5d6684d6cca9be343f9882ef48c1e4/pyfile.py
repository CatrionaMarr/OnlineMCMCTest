...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/2d5d6684d6cca9be343f9882ef48c1e4")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/2d5d6684d6cca9be343f9882ef48c1e4")
  success = False

database_add_row("2d5d6684d6cca9be343f9882ef48c1e4", "m*x+c", "m,c", 2, success)
