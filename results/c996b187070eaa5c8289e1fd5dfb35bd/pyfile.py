...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/c996b187070eaa5c8289e1fd5dfb35bd")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/c996b187070eaa5c8289e1fd5dfb35bd")
  success = False

database_add_row("c996b187070eaa5c8289e1fd5dfb35bd", "m*x+c", "m,c", 2, success)
