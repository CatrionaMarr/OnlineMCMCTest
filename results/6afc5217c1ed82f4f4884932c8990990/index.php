...
<div id="margpos" class="container-fluid bg-4 text-left">
...
<tr><td>\(m\)</td><td>1.0</td><td>1.0</td><td>1.0</td><td>0.2</td><td>[0.8, 1.2]</td><td>[0.6, 1.4]</td></tr><tr><td>\(c\)</td><td>-0.0</td><td>-0.0</td><td>-4.3&times;10<sup>-4</sup></td><td>0.7</td><td>[-0.7, 0.7]</td><td>[-1.3, 1.4]</td></tr></table>
...
<tr><td>\(m\)</td><td>1.00</td><td>-0.90</td></tr>
<tr><td>\(c\)</td><td>-0.90</td><td>1.00</td></tr>
</table>
...
<li><a href="variables.txt"><code>variables.txt</code></a> - the variables in the order of the posterior file</li>
 ...
 <footer class="container-fluid bg-4 text-center">
    ...
    <p class="footer"> <strong> &copy; Matthew Pitkin (2015). </strong>The code for this site is licensed under the <a href="http://opensource.org/licenses/MIT">MIT license</a>. It is available on <a href="https://github.com/mattpitkin/theonlinemcmc">github</a> and <a href="https://bitbucket.org/mattpitkin/theonlinemcmc">bitbucket</a>.<br>This site is kindly hosted by the <a href="http://www.gla.ac.uk/schools/physics/">School of Physics & Astronomy</a> at the <a href="http://www.gla.ac.uk/">University of Glasgow</a>. They bear no reponsibility for the content of this site or the results that are produced.
</p>

<!-- include social media sharing -->
<?php
$shareurl = "http://localhost/results/1c29bd7417c37cefb2402edcda36baae";
include('../../social.inc');
?>
</div>
</body>
