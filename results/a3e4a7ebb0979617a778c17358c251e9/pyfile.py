...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/a3e4a7ebb0979617a778c17358c251e9")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/a3e4a7ebb0979617a778c17358c251e9")
  success = False

database_add_row("a3e4a7ebb0979617a778c17358c251e9", "m*x", "m", 1, success)
