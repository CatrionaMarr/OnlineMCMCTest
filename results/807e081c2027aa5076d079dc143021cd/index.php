...
<p>
The diagonal plots show the <a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Marginal_distribution">marginal</a>
<a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Posterior_probability">posterior probability</a> distributions for each of your
fitted parameters. The off-diagonal plots show 1 and 2&sigma; probability contours for the
<a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Joint_probability_distribution">joint</a> marginal posterior probability distributions of pairs of parameters. This has been produced with <a style="color: #BD5D38" href="https://github.com/dfm/corner.py">corner.py</a>.
</p>
...
<tr><td>\(m\)</td><td>1.0</td><td>1.0</td><td>1.0</td><td>0.3</td><td>[0.7, 1.3]</td><td>[0.4, 1.6]</td></tr><tr><td>\(C\)</td><td>-0.0</td><td>-0.0</td><td>1.0&times;10<sup>-4</sup></td><td>0.8</td><td>[-0.8, 0.8]</td><td>[-1.6, 1.5]</td></tr></table>
...
<tr><td>\(m\)</td><td>1.00</td><td>-0.92</td></tr>
<tr><td>\(C\)</td><td>-0.92</td><td>1.00</td></tr>
</table>
...
<?php
$shareurl = "http://localhost/results/5989fadf55d71d81c7fc9e4a412beb7e";
include('../../social.inc');
?>
</div>
</body>
