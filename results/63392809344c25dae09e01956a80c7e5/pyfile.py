...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/63392809344c25dae09e01956a80c7e5")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/63392809344c25dae09e01956a80c7e5")
  success = False

database_add_row("63392809344c25dae09e01956a80c7e5", "m*x+c", "m,c", 2, success)
