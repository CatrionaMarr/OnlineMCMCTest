...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/1a3a5036098955543a61ab0baafcf73d")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/1a3a5036098955543a61ab0baafcf73d")
  success = False

database_add_row("1a3a5036098955543a61ab0baafcf73d", "m*x+c", "m,c", 2, success)
