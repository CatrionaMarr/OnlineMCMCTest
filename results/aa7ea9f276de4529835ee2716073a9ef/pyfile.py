...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/aa7ea9f276de4529835ee2716073a9ef")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/aa7ea9f276de4529835ee2716073a9ef")
  success = False

database_add_row("aa7ea9f276de4529835ee2716073a9ef", "m*x+c", "m,c", 2, success)
