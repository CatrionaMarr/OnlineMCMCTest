...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/4c28c0866c33fcabd080fc272a571c65")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/4c28c0866c33fcabd080fc272a571c65")
  success = False

database_add_row("4c28c0866c33fcabd080fc272a571c65", "m*x+c", "m,c", 2, success)
