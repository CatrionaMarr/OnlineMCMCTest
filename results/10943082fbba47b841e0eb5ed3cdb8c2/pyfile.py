...
try:
  ...
  cini = 1 + np.random.randn(Nens)*0.2
...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/10943082fbba47b841e0eb5ed3cdb8c2")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/10943082fbba47b841e0eb5ed3cdb8c2")
  success = False

  # run post-processing script
  try:
    MCMCWrapper(1 2 3 4, "m,c", m,x,c, "emcee")
database_add_row("10943082fbba47b841e0eb5ed3cdb8c2", "m*x+c", "m,c", 2, success)
