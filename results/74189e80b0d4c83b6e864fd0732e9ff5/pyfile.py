...
try:
  mini = 1.8 + np.random.randn(Nens)*0.5
...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "you@example.com", "http://localhost/results/74189e80b0d4c83b6e864fd0732e9ff5")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "you@example.com", "http://localhost/results/74189e80b0d4c83b6e864fd0732e9ff5")
  success = False
