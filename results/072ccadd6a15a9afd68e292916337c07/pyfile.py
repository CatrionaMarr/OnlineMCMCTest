...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/072ccadd6a15a9afd68e292916337c07")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/072ccadd6a15a9afd68e292916337c07")
  success = False

database_add_row("072ccadd6a15a9afd68e292916337c07", "m*x+c", "m,c", 2, success)
