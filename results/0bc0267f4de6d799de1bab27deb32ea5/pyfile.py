...
if errval == 0:
  ...
  try:
    postprocessing(samples, "m,c", x, "x", data, "fanatapan@yahoo.co.uk", "http://localhost/results/0bc0267f4de6d799de1bab27deb32ea5")
  except:
...
if errval != 0:
  ...
  errorpage(errval, "fanatapan@yahoo.co.uk", "http://localhost/results/0bc0267f4de6d799de1bab27deb32ea5")
  success = False

  # run post-processing script
  try:
    MCMCWrapper(1 2 3 4, "m,c", m,x,c, "emcee")
database_add_row("0bc0267f4de6d799de1bab27deb32ea5", "m*x+c", "m,c", 2, success)
